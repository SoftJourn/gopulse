...
func (r *Resolver) CreateUser(ctx context.Context, args *struct {
	...
	return ResolveCreateUser(args.FirstName, args.LastName, args.Email, args.Password, args.Nickname)
}
...
func (r *Resolver) UpdateUser(ctx context.Context, args *struct {
	...
	return ResolveUpdateUser(string(args.Id), args.FirstName, args.LastName, args.Email, args.Password, args.Nickname)
}
